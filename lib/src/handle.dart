...
import 'package:offline_data/src/fetchData/entry.dart';
...
abstract class Handle {
  factory Handle([BaseOptions options]) => createHandle(options);
  ...
  ///
  /// If [force] is `false` (the default) the [Handle] will be kept alive
...
// abstract class DioMixin implements Handle {
//   /// Default Request config. More see [BaseOptions].
//   @override
//   BaseOptions options;
//
...
//     if (response is CallBack<T>) {
//       response.request = response.request ?? requestOptions;
//     } else if (response is! Response) {
//       response = CallBack<T>(data: response, request: requestOptions);
//     } else {
