...
/// HttpAdapter is a bridge between CacheApi and HttpClient.
///
/// CacheApi: Implements standard and friendly API for developer.
///
...
///
/// The default HttpClientAdapter for CacheApi is [DefaultHttpClientAdapter].
///
/// ```dart
/// cacheApi.httpClientAdapter = DefaultHttpClientAdapter();
/// ```
